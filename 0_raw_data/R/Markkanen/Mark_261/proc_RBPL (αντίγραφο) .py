...
aperts     = [11.0,12.5,13.0,13.5,14.0] # radius in pixels
aperts_in  = [20.0,20.0,20.0,20.0,20.0]
aperts_out = [30.0,30.0,30.0,30.0,30.0]

MANUAL_FOR_ALL_SHOTS = True
#MANUAL_FOR_ALL_SHOTS = False

LEVELS = 80 # in percent change to 80 for bright stars
