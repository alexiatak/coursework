...
aperts     = [14.0,15.0,16.0,17.0,18.0,19.0] # radius in pixels
aperts_in  = [23.0,23.0,23.0,23.0,23.0,23.0]
aperts_out = [31.0,31.0,31.0,31.0,31.0,31.0]
...
LEVELS = 96.0 # in percent change to 80 for bright stars
