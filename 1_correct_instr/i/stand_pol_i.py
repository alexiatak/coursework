...
STANDARDS = {# polarized
             "HD183143"   : star(PD=5.43,PDerr=0.03,PA=179.0,PAerr=0.2),      # https://articles.adsabs.harvard.edu/pdf/1982ApJ...262..732H
             # unpolarized
             "BD+28.4211" : star(PD=0.054,PDerr=0.027,PA=54.22,PAerr=0.0),   # using V band Schmidt92
             "BD+32.3739" : star(PD=0.025,PDerr=0.017,PA=35.79,PAerr=0.0),   # using V band Schmidt92
             "BD+33.2642" : star(PD=0.231,PDerr=0.031,PA=12.67,PAerr=0.0),   # using V from https://james.as.arizona.edu/~psmith/SPOL/unpolstds/bd332642.html but may have changed Skalidis18
             "BD+40.2704" : star(PD=0.07,PDerr=0.02,PA=57,PAerr=9),          # Berdyugin2002
             "HD154892"   : star(PD=0.05,PDerr=0.03,PA=0.0,PAerr=0.0),       # using B from  Turnishek90
             }
