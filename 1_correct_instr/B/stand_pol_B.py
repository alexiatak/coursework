...
STANDARDS = {# polarized
             "HD183143"   : star(PD=5.89,PDerr=0.04,PA=179.5,PAerr=0.2),      # https://articles.adsabs.harvard.edu/pdf/1982ApJ...262..732H
             # unpolarized
             "BD+28.4211" : star(PD=0.063,PDerr=0.023,PA=30.30,PAerr=0.0),   # Schmidt92
             "BD+32.3739" : star(PD=0.039,PDerr=0.021,PA=79.38,PAerr=0.0),   # Schmidt92
             "BD+33.2642" : star(PD=0.145,PDerr=0.029,PA=29.69,PAerr=0.0),     # from https://james.as.arizona.edu/~psmith/SPOL/unpolstds/bd332642.html but may have changed Skalidis18
