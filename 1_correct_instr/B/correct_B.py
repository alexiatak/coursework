...
import pickle
import stand_pol_B as stand_pol
...
def main():
    ...
    import os
    backup_dir = "../../0_data/B"  # CHANGE THIS PATH
    os.makedirs(backup_dir, exist_ok=True)

    import shutil
    shutil.copy('Mark_B_corr.dat', os.path.join(backup_dir, 'Mark_B_corr.dat'))
    print(f"Copied to {backup_dir}")
        
    
    print("Data written to Mark_B_corr.dat")
