...
import pickle
import stand_pol_g as stand_pol
...
def main():
    ...
    import os
    backup_dir = "../../0_data/G"  # CHANGE THIS PATH
    os.makedirs(backup_dir, exist_ok=True)

    import shutil
    shutil.copy('Mark_g_corr.dat', os.path.join(backup_dir, 'Mark_g_corr.dat'))
    print(f"Copied to {backup_dir}")
        
    
    print("Data written to Mark_g_corr.dat")
